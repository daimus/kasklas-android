...
public class StudentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<StudentListModel> items = new ArrayList<>();
    boolean loading;
    ...
    public StudentAdapter(Context context, int item_per_display) {
        this.items = items;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        final StudentListModel item = items.get(position);
        if (holder instanceof OriginalViewHolder) {
            final OriginalViewHolder view = (OriginalViewHolder) holder;
            view.name_TV.setText(item.getName());
            view.phone_TV.setText(item.getPhone());
            view.address_TV.setText(item.getAddress());
            ColorGenerator generator = ColorGenerator.MATERIAL;
            int bgcolor = generator.getRandomColor();
            TextDrawable drawable = TextDrawable.builder()
                    .buildRound(String.valueOf(item.getName().trim().charAt(0)), bgcolor);
            view.icon_IV.setImageDrawable(drawable);
    ...
    public void insertData(List<StudentListModel> items) {
        setLoaded();
    ...
    public void setLoading() {
        if (getItemCount() != 0) {
            ...
            this.items.add(new StudentListModel(true));
    ...
    public StudentListModel getItem(int pos){
    ...
    public interface OnClickListener {
        void onItemClick(View view, StudentListModel obj, int pos);

        void onItemLongClick(View view, StudentListModel obj, int pos);
    }
