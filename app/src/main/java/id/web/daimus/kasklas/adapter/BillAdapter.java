...
public class BillAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<BillListModel> items = new ArrayList<>();
    boolean loading;
    ...
    public BillAdapter(Context context, int item_per_display) {
        this.items = items;
    ...
    public class OriginalViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView name_TV, bill_TV, studentId_TV;
        View parent_LL;
        public OriginalViewHolder(View v) {
            super(v);
            name_TV = (TextView) v.findViewById(R.id.name_TV);
            studentId_TV = (TextView) v.findViewById(R.id.studentId_TV);
            bill_TV = (TextView) v.findViewById(R.id.bill_TV);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        final BillListModel item = items.get(position);
        if (holder instanceof OriginalViewHolder) {
            final OriginalViewHolder view = (OriginalViewHolder) holder;
            view.name_TV.setText(item.getName());
            view.studentId_TV.setText(item.getStudentId());
            ...
            Double bill = (item.getTotalBill() == null) ? 0 : item.getTotalBill();

            view.bill_TV.setText(String.valueOf(indonesianCurrency.format(bill)));
            if (bill <= 0){
                Double newBill = bill * 2 - bill;
                view.bill_TV.setTextColor(Color.parseColor("#7CB342"));
                view.bill_TV.setText(String.valueOf(indonesianCurrency.format(newBill)));
            }
    ...
    public void insertData(List<BillListModel> items) {
        setLoaded();
    ...
    public void setLoading() {
        if (getItemCount() != 0) {
            ...
            this.items.add(new BillListModel(true));
    ...
    public BillListModel getItem(int pos){
    ...
    public interface OnClickListener {
        void onItemClick(View view, BillListModel obj, int pos);

        void onItemLongClick(View view, BillListModel obj, int pos);
    }
