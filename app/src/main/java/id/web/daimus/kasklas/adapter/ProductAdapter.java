...
public class ProductAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        final ProductListModel item = items.get(position);
    ...
    public void insertData(List<ProductListModel> items) {
        setLoaded();
    ...
    public void setLoading() {
        if (getItemCount() != 0) {
            ...
            this.items.add(new ProductListModel(true));
    ...
    public ProductListModel getItem(int pos){
    ...
    public interface OnClickListener {
        void onItemClick(View view, ProductListModel obj, int pos);

        void onItemLongClick(View view, ProductListModel obj, int pos);
    }
}