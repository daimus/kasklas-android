...
public class PaymentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<PaymentListModel> items = new ArrayList<>();
    boolean loading;
    ...
    public PaymentAdapter(Context context, int item_per_display) {
        this.items = items;
    ...
    public class OriginalViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView icon_IV;
        TextView name_TV, paymentNo_TV, timestamp_TV, amount_TV;
        View parent_LL;
        public OriginalViewHolder(View v) {
            super(v);
            icon_IV = (ImageView) v.findViewById(R.id.icon_IV);
            name_TV = (TextView) v.findViewById(R.id.name_TV);
            paymentNo_TV = (TextView) v.findViewById(R.id.paymentNo_TV);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        final PaymentListModel item = items.get(position);
        if (holder instanceof OriginalViewHolder) {
            final OriginalViewHolder view = (OriginalViewHolder) holder;
            view.name_TV.setText(item.getName());
            view.paymentNo_TV.setText(item.getPaymentNo());
    ...
    public void insertData(List<PaymentListModel> items) {
        setLoaded();
    ...
    public void setLoading() {
        if (getItemCount() != 0) {
            ...
            this.items.add(new PaymentListModel(true));
    ...
    public PaymentListModel getItem(int pos){
    ...
    public interface OnClickListener {
        void onItemClick(View view, PaymentListModel obj, int pos);

        void onItemLongClick(View view, PaymentListModel obj, int pos);
    }
